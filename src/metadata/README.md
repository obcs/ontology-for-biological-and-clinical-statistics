 ...
 * [obcs.yml](obcs.yml)
     * Determines how your purl.obolibrary.org/obo/obcs/ redirects will be handled
     ...
     * Paste in the contents of [obcs.yml](obcs.yml)
 ...
 * [obcs.md](obcs.md)
     ...
     * Paste in the contents of [obcs.md](obcs.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
