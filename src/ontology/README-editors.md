These notes are for the EDITORS of obcs
...
Make sure you have an ID range in the [idranges file](obcs-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [obcs-edit.owl](obcs-edit.owl)

** DO NOT EDIT obcs.obo OR obcs.owl in the top level directory **

[../../obcs.owl](../../obcs.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/obcs/ontology-for-biological-and-clinical-statistics) for details.
 ...
 * [obcs-idranges.owl](obcs-idranges.owl)
...
This generates derived files such as obcs.owl and obcs.obo and places
 ...
 * https://github.com/obcs/ontology-for-biological-and-clinical-statistics/releases
 * https://github.com/obcs/ontology-for-biological-and-clinical-statistics/releases/new
...
what is in the `owl:versionIRI` of the derived obcs.owl (`data-version` in
obcs.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/obcs.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/obcs/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/obcs/ontology-for-biological-and-clinical-statistics.svg?branch=master)](https://travis-ci.org/obcs/ontology-for-biological-and-clinical-statistics)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/obcs](https://travis-ci.org/profile/obcs)
 2. click the "Sync account" button
 3. Click the tick symbol next to ontology-for-biological-and-clinical-statistics
